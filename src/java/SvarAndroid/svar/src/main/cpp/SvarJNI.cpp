...
jobject Svar2JObject(JNIEnv *env,Svar var){
    jclass jcInfo = env->FindClass("com/gslam/svar/Svar");
    jmethodID method= env->GetStaticMethodID(jcInfo,"createFromNative","(J)Lcom/gslam/svar/Svar;");
...
Java_com_gslam_svar_Svar_callNative__Lcom_gslam_svar_Svar_2(JNIEnv *env,
                                                                              jobject instance,
                                                                              jobject args) {
...
JNIEXPORT jobject JNICALL
Java_com_gslam_svar_Svar_callNative__Ljava_lang_String_2Lcom_gslam_svar_Svar_2(
...
Java_com_gslam_svar_Svar_clear(JNIEnv *env, jobject instance) {
    getThisSvar(env,instance);
}

JNIEXPORT void JNICALL
Java_com_gslam_svar_Svar_erase(JNIEnv *env, jobject instance, jstring id_) {
...
JNIEXPORT jobject JNICALL
Java_com_gslam_svar_Svar_instance(JNIEnv *env, jclass type) {
    return Svar2JObject(env,Svar::instance());
}

JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isJavaObject(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).is<jobject>();
}

JNIEXPORT void JNICALL
Java_com_gslam_svar_Svar_set(JNIEnv *env, jobject instance, jstring id_, jobject obj) {
    const char *id = env->GetStringUTFChars(id_, 0);
...
JNIEXPORT jobject JNICALL
Java_com_gslam_svar_Svar_mapGet(JNIEnv *env, jobject instance, jstring value_) {
...
Java_com_gslam_svar_Svar_length(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).length();
}

JNIEXPORT jobject JNICALL
Java_com_gslam_svar_Svar_get(JNIEnv *env, jobject instance, jint value) {
    return Svar2JObject(env,getThisSvar(env,instance)[value]);
}

JNIEXPORT jobject JNICALL
Java_com_gslam_svar_Svar_getMap(JNIEnv *env, jobject instance, jstring id_) {
    const char *id = env->GetStringUTFChars(id_, 0);
...
Java_com_gslam_svar_Svar_createList(JNIEnv *env, jobject instance, jint length,
                                                jobjectArray list) {
...
JNIEXPORT void JNICALL
Java_com_gslam_svar_Svar_add(JNIEnv *env, jobject instance, jobject obj) {
    getThisSvar(env,instance).push_back(getThisSvar(env,obj));
}


JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isClass(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).isClass();
}

JNIEXPORT jstring JNICALL
Java_com_gslam_svar_Svar_type(JNIEnv *env, jobject instance) {
    return env->NewStringUTF(getThisSvar(env,instance).typeName().c_str());
}

JNIEXPORT jstring JNICALL
Java_com_gslam_svar_Svar_toString(JNIEnv *env, jobject instance) {
...
JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isFunction(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).isFunction();
}

JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isUndefined(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).isUndefined();
}

JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isNull(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).isNull();
}

JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isBoolean(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).is<bool>();
}

JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isChar(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).is<char>();
}

JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isByte(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).is<u_char>();
}

JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isShort(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).is<int16_t >();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isInt(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).is<int>();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isDouble(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).is<double>();
}

extern "C"
JNIEXPORT jlong JNICALL
Java_com_gslam_svar_Svar_Undefined(JNIEnv *env, jobject instance) {
    return (jlong)new Svar();
}

extern "C"
JNIEXPORT jlong JNICALL
Java_com_gslam_svar_Svar_Null(JNIEnv *env, jobject instance) {
    return (jlong)new Svar(nullptr);
}

extern "C"
JNIEXPORT jlong JNICALL
Java_com_gslam_svar_Svar_create__Z(JNIEnv *env, jobject instance, jboolean value) {
    return (jlong)new Svar((bool)value);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_gslam_svar_Svar_release(JNIEnv *env, jclass instance, jlong ptr) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_gslam_svar_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isList(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).isArray();
}

JNIEXPORT jboolean JNICALL
Java_com_gslam_svar_Svar_isMap(JNIEnv *env, jobject instance) {
    return getThisSvar(env,instance).isObject();
}

JNIEXPORT jlong JNICALL
Java_com_gslam_svar_Svar_create__I(JNIEnv *env, jobject instance, jint value) {
    return (jlong)new Svar((int)value);
}

JNIEXPORT jlong JNICALL
Java_com_gslam_svar_Svar_create__D(JNIEnv *env, jobject instance, jdouble value) {
    return (jlong)new Svar((int)value);
}

JNIEXPORT jlong JNICALL
Java_com_gslam_svar_Svar_create__Ljava_lang_String_2(JNIEnv *env, jobject instance,
                                                                 jstring value_) {
    const char *value = env->GetStringUTFChars(value_, 0);
    env->ReleaseStringUTFChars(value_, value);
